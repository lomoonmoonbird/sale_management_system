...
for grade, exerciseid_list in EXERCISE.items(): #每个年级的考试
    flag = False
    wb = Workbook("./exercises/" + grade +".xlsx")
    wb.create_sheet(title="sheet")
    ws = wb['sheet']
    # exerciseid_list.insert(0, exerciseid_list[0])
    for e_index, exerciseid in enumerate(exerciseid_list): #每个考试
