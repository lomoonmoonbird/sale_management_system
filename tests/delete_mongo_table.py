...
collections = ["channel_per_day", "class_per_day", "school_per_day","grade", "grade_per_day",
               ...
               "record_channel_reading_delta", "record_class_reading_delta", "record_grade_reading_delta",
               "record_school_reading_delta", "record_channel_unique_guardian_delta", "record_class_unique_guardian_delta",
               "record_grade_unique_guardian_delta", "record_school_unique_guardian_delta", "jinpengtest"]
